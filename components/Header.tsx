    ...
    <header className="flex flex-wrap justify-between items-center px-4 py-2">
      <div className="flex flex-wrap justify-between items-center w-full">
        ...
        <div className="flex items-center space-x-4 sm:mt-0 mt-4 flex-1 md:flex-none">
          <Link
            href={"/basket"}
            className="flex-1 relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 rounded"
          >
